    ...
    <div className="flex min-h-full flex-col pb-20 md:pb-0">
      ...
      <main className="mx-auto w-full max-w-4xl flex-1 px-4 py-8 sm:px-6">
        ...
        <div className="mt-8 grid gap-4 md:grid-cols-2">
          <ScrollReveal variant="up" duration={750}>
          ...
          <ScrollReveal variant="up" delay={120} duration={750}>
        ...
        <ScrollReveal variant="up" delay={80} duration={800} className="mt-10">
          <section className="border border-line p-5 text-sm text-navy/80">
