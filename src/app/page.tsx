  ...
  return (
    <div className="flex min-h-full flex-col bg-white">
      ...
      <main className="mx-auto w-full max-w-7xl flex-1 px-4 pb-12 sm:px-6">
          ...
          <div className="grid gap-px border border-line bg-line sm:grid-cols-2 lg:grid-cols-5">
            {SECTORS.map((s) => (
              <Link
                key={s.id}
                href={`/sector/${s.id}`}
                className="bg-white p-4 transition hover:bg-secondary"
              >
        ...
        <section className="mt-10 flex flex-wrap items-center justify-between gap-4 border border-navy bg-navy px-5 py-6 text-white">
          <div>
